...
public class RemoteEJBClient {
    ...
    private static void invokeStatelessBean() throws NamingException {
        ...
        final CalculatorService statelessRemoteCalculator = lookupRemoteStatelessCalculator();
    ...
    private static void invokeStatefulBean() throws NamingException {
        ...
        final CounterService statefulRemoteCounter = lookupRemoteStatefulCounter();
     ...
     * @throws NamingException
     */
    private static CalculatorService lookupRemoteStatelessCalculator() throws NamingException {
      ...
      //                  the whole package name.
        ...
        // let's do the lookup
      return (CalculatorService) context.lookup(
         "ejb:/jboss-as-ejb-remote-app/CalculatorBean!" + CalculatorService.class.getName()
      );
    }
     ...
     * @throws NamingException
     */
    private static CounterService lookupRemoteStatefulCounter() throws NamingException {
        final Hashtable jndiProperties = new Hashtable();
        jndiProperties.put(Context.URL_PKG_PREFIXES, "org.jboss.ejb.client.naming");
        final Context context = new InitialContext(jndiProperties);
      ...
      // let's do the lookup
      return (CounterService) context.lookup(
         "ejb:/jboss-as-ejb-remote-app/CounterBean!" + CounterService.class.getName()+"?stateful"
      );
    }
}
